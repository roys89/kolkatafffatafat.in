                                ...
                                <div class="overflow-x-auto">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            $urlAccepted = "tran-submit.php?tran_id=" . $row['tran_id'] . "&user_id=" . $row['phone'] . "&transaction_request=" . $row['transaction_request'] . "&status=approved";

                                             $urlRejected = "tran-submit.php?tran_id=" . $row['tran_id'] . "&user_id=" . $row['phone'] . "&transaction_request=" . $row['transaction_request'] . "&status=rejected";
                                            echo '  <tbody>
                                                                    <tr>
