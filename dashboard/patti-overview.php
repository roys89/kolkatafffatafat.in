                    ...
                    <div class="flex gap-3 ms-auto">
                        ...
                        <div class="relative flex items-center dropdown h-header">
                            ...
                            <div class="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[14rem] dark:bg-zink-600" aria-labelledby="dropdownMenuButton">
                                <h6 class="mb-2 text-sm font-normal text-slate-500 dark:text-zink-300">Welcome to Kolkata FF Live</h6>
        ...
        <div class="group-data-[sidebar-size=lg]:ltr:md:ml-vertical-menu group-data-[sidebar-size=lg]:rtl:md:mr-vertical-menu group-data-[sidebar-size=md]:ltr:ml-vertical-menu-md group-data-[sidebar-size=md]:rtl:mr-vertical-menu-md group-data-[sidebar-size=sm]:ltr:ml-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:mr-vertical-menu-sm pt-[calc(theme('spacing.header')_*_1)] pb-[calc(theme('spacing.header')_*_0.8)] px-4 group-data-[navbar=bordered]:pt-[calc(theme('spacing.header')_*_1.3)] group-data-[navbar=hidden]:pt-0 group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl group-data-[layout=horizontal]:px-0 group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:ltr:md:ml-auto group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:rtl:md:mr-auto group-data-[layout=horizontal]:md:pt-[calc(theme('spacing.header')_*_1.8)] group-data-[layout=horizontal]:px-3 group-data-[layout=horizontal]:group-data-[navbar=hidden]:pt-[calc(theme('spacing.header')_*_0.9)]">
                ...
                <div class="card-body">
                            <div class="grid items-center grid-cols-1 gap-3 mb-5 2xl:grid-cols-12">
                                <div class="2xl:col-span-3">
                                    <h6 class="text-15">Patti Bets (Baji 1)</h6> 
                                </div><!--end col-->
                            </div><!--end grid-->
                                ...
                                <?php
                                    ...
                                    if (isset($_GET['bet_number'])) {
                                        ...
                                        $query = "SELECT
                                                    ...
                                                    phone
                                                FROM bet_table
                                                WHERE bet_number = ? AND baji = 1 AND game_type= 'patti'
                                                GROUP BY user_id";
            ...
            <div class="col-span-12 card 2xl:col-span-12">
                <div class="card-body">
                            <div class="grid items-center grid-cols-1 gap-3 mb-5 2xl:grid-cols-12">
                                <div class="2xl:col-span-3">
                                    <h6 class="text-15">Patti Bets (Baji 2)</h6> 
                                </div><!--end col-->
                            </div><!--end grid-->
                    <div class="overflow-x-auto">
                                <?php
                                    ...
                                    if (isset($_GET['bet_number'])) {
                                        ...
                                        $query = "SELECT
                                                    ...
                                                    phone
                                                FROM bet_table
                                                WHERE bet_number = ? AND baji = 2 AND game_type= 'patti'
                                                GROUP BY user_id";
            ...
            <div class="col-span-12 card 2xl:col-span-12">
                <div class="card-body">
                            <div class="grid items-center grid-cols-1 gap-3 mb-5 2xl:grid-cols-12">
                                <div class="2xl:col-span-3">
                                    <h6 class="text-15">Patti Bets  (Baji 3)</h6> 
                                </div><!--end col-->
                            </div><!--end grid-->
                    <div class="overflow-x-auto">
                                <?php
                                    ...
                                    if (isset($_GET['bet_number'])) {
                                        ...
                                        $query = "SELECT
                                                    ...
                                                    phone
                                                FROM bet_table
                                                WHERE bet_number = ? AND baji = 3 AND game_type= 'patti'
                                                GROUP BY user_id";
            ...
            <div class="col-span-12 card 2xl:col-span-12">
                <div class="card-body">
                            <div class="grid items-center grid-cols-1 gap-3 mb-5 2xl:grid-cols-12">
                                <div class="2xl:col-span-3">
                                    <h6 class="text-15">Patti Bets  (Baji 4)</h6> 
                                </div><!--end col-->
                            </div><!--end grid-->
                    <div class="overflow-x-auto">
                                <?php
                                    ...
                                    if (isset($_GET['bet_number'])) {
                                        ...
                                        $query = "SELECT
                                                    ...
                                                    phone
                                                FROM bet_table
                                                WHERE bet_number = ? AND baji = 4 AND game_type= 'patti'
                                                GROUP BY user_id";
            ...
            <div class="col-span-12 card 2xl:col-span-12">
                <div class="card-body">
                            <div class="grid items-center grid-cols-1 gap-3 mb-5 2xl:grid-cols-12">
                                <div class="2xl:col-span-3">
                                    <h6 class="text-15">Patti Bets  (Baji 5)</h6> 
                                </div><!--end col-->
                            </div><!--end grid-->
                    <div class="overflow-x-auto">
                                <?php
                                    ...
                                    if (isset($_GET['bet_number'])) {
                                        ...
                                        $query = "SELECT
                                                    ...
                                                    phone
                                                FROM bet_table
                                                WHERE bet_number = ? AND baji = 5 AND game_type= 'patti'
                                                GROUP BY user_id";
            ...
            <div class="col-span-12 card 2xl:col-span-12">
                <div class="card-body">
                            <div class="grid items-center grid-cols-1 gap-3 mb-5 2xl:grid-cols-12">
                                <div class="2xl:col-span-3">
                                    <h6 class="text-15">Patti Bets  (Baji 6)</h6> 
                                </div><!--end col-->
                            </div><!--end grid-->
                    <div class="overflow-x-auto">
                                <?php
                                    ...
                                    if (isset($_GET['bet_number'])) {
                                        ...
                                        $query = "SELECT
                                                    ...
                                                    phone
                                                FROM bet_table
                                                WHERE bet_number = ? AND baji = 6 AND game_type= 'patti'
                                                GROUP BY user_id";
            ...
            <div class="col-span-12 card 2xl:col-span-12">
                <div class="card-body">
                            <div class="grid items-center grid-cols-1 gap-3 mb-5 2xl:grid-cols-12">
                                <div class="2xl:col-span-3">
                                    <h6 class="text-15">Patti Bets  (Baji 7)</h6> 
                                </div><!--end col-->
                            </div><!--end grid-->
                    <div class="overflow-x-auto">
                                <?php
                                    ...
                                    if (isset($_GET['bet_number'])) {
                                        ...
                                        $query = "SELECT
                                                    ...
                                                    phone
                                                FROM bet_table
                                                WHERE bet_number = ? AND baji = 7 AND game_type= 'patti'
                                                GROUP BY user_id";
            ...
            <div class="col-span-12 card 2xl:col-span-12">
                <div class="card-body">
                            <div class="grid items-center grid-cols-1 gap-3 mb-5 2xl:grid-cols-12">
                                <div class="2xl:col-span-3">
                                    <h6 class="text-15">Patti Bets  (Baji 8)</h6> 
                                </div><!--end col-->
                            </div><!--end grid-->
                    <div class="overflow-x-auto">
                                <?php
                                    ...
                                    if (isset($_GET['bet_number'])) {
                                        ...
                                        $query = "SELECT
                                                    ...
                                                    phone
                                                FROM bet_table
                                                WHERE bet_number = ? AND baji = 8 AND game_type= 'patti'
                                                GROUP BY user_id";
        ...
        <footer class="ltr:md:left-vertical-menu rtl:md:right-vertical-menu group-data-[sidebar-size=md]:ltr:md:left-vertical-menu-md group-data-[sidebar-size=md]:rtl:md:right-vertical-menu-md group-data-[sidebar-size=sm]:ltr:md:left-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:md:right-vertical-menu-sm absolute right-0 bottom-0 px-4 h-14 group-data-[layout=horizontal]:ltr:left-0  group-data-[layout=horizontal]:rtl:right-0 left-0 border-t py-3 flex items-center dark:border-zink-600">
            <div class="group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl w-full">
                <div class="grid items-center grid-cols-1 text-center lg:grid-cols-2 text-slate-400 dark:text-zink-200 ltr:lg:text-left rtl:lg:text-right">
                    <div>
                        <script>document.write(new Date().getFullYear())</script> © Kolkata FF Live.
                    </div>
